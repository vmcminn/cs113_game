...
class PygButton(object):
    def __init__(self, rect=None, caption='', bgcolor=BLACK, fgcolor=DKRED, font=None, normal=None, down=None, highlight=None, opacity=None):
        ...
        if opacity is None:
            self.surfaceNormal.set_alpha(255)
            self.surfaceDown.set_alpha(255)
            self.surfaceHighlight.set_alpha(255)
        else:
            self.surfaceNormal.set_alpha(opacity)
            self.surfaceDown.set_alpha(opacity)
            self.surfaceHighlight.set_alpha(opacity)
    ...
    def _update(self):
        ...
        pygame.draw.line(self.surfaceNormal, DGREY, (1, h - 1), (w - 1, h - 1))
        pygame.draw.line(self.surfaceNormal, DGREY, (w - 1, 1), (w - 1, h - 1))
        pygame.draw.line(self.surfaceNormal, BLACK, (2, h - 2), (w - 2, h - 2))
        pygame.draw.line(self.surfaceNormal, BLACK, (w - 2, 2), (w - 2, h - 2))
        ...
        pygame.draw.line(self.surfaceDown, DGREY, (1, h - 2), (1, 1))
        pygame.draw.line(self.surfaceDown, DGREY, (1, 1), (w - 2, 1))
        pygame.draw.line(self.surfaceDown, BLACK, (2, h - 3), (2, 2))
        pygame.draw.line(self.surfaceDown, BLACK, (2, 2), (w - 3, 2))
